...
<script src="${root }js/summernote-lite.js"></script>
<script src="${root }js/summernote-ko-KR.js"></script>
<link rel="stylesheet" href="${root }css/summernote-lite.css"> --%>
</head>
<body>
<div id="wrap">
<!-- 상단 메뉴 부분 -->
			...
			<div class="card shadow">
				<div class="card-body">
					<form:form action="${root }board/write_pro" method="post" modelAttribute="writeContentBean" enctype="multipart/form-data">
						...
						<%-- <input type="hidden" name="content_board_idx" value="${writeContentBean.content_board_idx }"> --%>
